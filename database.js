...
function DB() {
	...
	this.authenticate = function authenticate(id) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.checkDatabase = function checkDatabase() {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.getBasic = function getBasic() {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.getPhone = function getPhone(id) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.getSocial = function getSocial(id) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.getSkills = function getSkills(id) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.getTechnologies = function getTechnologies(id) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.getRepositories = function getRepositories(id) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.getExperience = function getExperience(id) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.getEducation = function getEducation(id) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.getPapers = function getPapers(id) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.getAchievements = function getAchievements(id) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.getInterests = function getInterests(id) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.verifyBasic = function verifyBasic(basicData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.verifyPhone = function verifyPhone(phoneData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.verifySocial = function verifySocial(socialData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.verifySkill = function verifySkill(skillData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.verifyTech = function verifyTech(techData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.verifyRepo = function verifyRepo(repoData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.verifyExperience = function verifyExperience(experienceData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.verifyEducation = function verifyEducation(educationData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.verifyPapers = function verifyPapers(paperData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.verifyAchievements = function verifyAchievements(achievmentData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.verifyInterests = function verifyInterests(InterestData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject(err);
	...
	this.saveBasic = function saveBasic(basicData) {
		return new Promise(function (resolve, reject) {
			var folderId;
	...
	this.savePhone = function savePhone(id, phoneData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject({
	...
	this.saveSocial = function saveSocial(id, socialData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject({
	...
	this.saveSkill = function saveSkill(id, skillData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject({
	...
	this.saveTechnology = function saveTechnology(id, technologyData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject({
	...
	this.saveRepository = function saveRepository(id, repositoryData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject({
	...
	this.saveExperience = function saveExperience(id, experienceData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject({
	...
	this.saveEducation = function saveEducation(id, educationData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject({
	...
	this.saveAchievement = function saveAchievement(id, achievementData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject({
	...
	this.saveInterest = function saveInterest(id, interestData) {
		return new Promise(function (resolve, reject) {
			pool.getConnection((err, conn) => {
				if (err) {
					return reject({
